...
This project examines an insurance dataset to identify the key factors influencing medical insurance charges. The analysis focuses on understanding which variables contribute most to cost differences through structured exploratory data analysis and targeted visualizations.
...
Insurance providers need a clear understanding of the factors influencing medical costs in order to accurately evaluate risk and determine appropriate policy pricing.
...
Insight: High-cost outliers are primarily associated with smokers and individuals with higher health risk indicators.
